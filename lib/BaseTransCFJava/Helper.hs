...
{- |
Module      :  BaseTransCFJavaHelper
Description :  Definitions and helper functions for the BaseTransCFJava
...
This module provides definitions and helper functions for the basic translation of FCore to Java.
The common/important things are re-exported by BaseTransCFJava,
please import from BaseTransCFJava, not BaseTransCFJava.Helper.
-}


module BaseTransCFJava.Helper where
...
data TransJavaExp = SingleVar J.Name
...
data VarAssignment = FromField | ToField
