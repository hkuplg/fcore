...
fact = Fix (\fact n ->
    If (PrimOp (Var n) (E.Compare J.Equal) (Lit (E.Integer 0)))
        (Lit (E.Integer 1))
        (PrimOp (Var n) (E.Arith J.Mult) (App (Var fact) (PrimOp (Var n) (E.Arith J.Sub) (Lit (E.Integer 1))))))
    (JClass "java.lang.Integer") (JClass "java.lang.Integer")

tfact = Fix (\fact n -> Lam (JClass "java.lang.Integer") (\acc ->
    If (PrimOp (Var n) (E.Compare J.Equal) (Lit (E.Integer 0)))
        (Var acc)
        (App (App (Var fact) (PrimOp (Var n) (E.Arith J.Sub) (Lit (E.Integer 1)))) (PrimOp (Var n) (E.Arith J.Mult) (Var acc)))))
...
fibo = Fix (\fibo n ->
    If (PrimOp (Var n) (E.Compare J.Equal) (Lit (E.Integer 2)))
        (Lit (E.Integer 1))
        (If (PrimOp (Var n) (E.Compare J.Equal) (Lit (E.Integer 1)))
             (Lit (E.Integer 1))
             (PrimOp (App (Var fibo) (PrimOp (Var n) (E.Arith J.Sub) (Lit (E.Integer 1)))) (E.Arith J.Add) (App (Var fibo) (PrimOp (Var n) (E.Arith J.Sub) (Lit (E.Integer 2)))))))
    (JClass "java.lang.Integer") (JClass "java.lang.Integer")

factApp = App fact (Lit (E.Integer 10))

fiboApp = App fibo (Lit (E.Integer 10))
-- /\A. \(x:A) . x
...
program1Num = App (TApp program1 (JClass "java.lang.Integer")) (Lit (E.Integer 5))
...
program2 = App (App (App (TApp notail2 (JClass "java.lang.Integer")) (TApp const (JClass "java.lang.Integer"))) (Lit (E.Integer 5))) (Lit (E.Integer 6))

idfNum = App (TApp idF (JClass "java.lang.Integer")) (Lit (E.Integer 10))

constNum = App (App (TApp const (JClass "java.lang.Integer")) (Lit (E.Integer 10))) (Lit (E.Integer 20))
...
program3 = App (App (App (App (TApp notail3 (JClass "java.lang.Integer")) (TApp const (JClass "java.lang.Integer"))) (TApp const (JClass "java.lang.Integer"))) (Lit (E.Integer 5))) (Lit (E.Integer 6))
...
summa =
    Lam (Fun (JClass "java.lang.Integer") (JClass "java.lang.Integer")) (\x ->
       Lam (Fun (JClass "java.lang.Integer") (JClass "java.lang.Integer")) (\y ->
          PrimOp (App (Var x) (Lit (E.Integer 0))) (E.Arith J.Add) (App (Var y) (Lit (E.Integer 0)))
       )
    )

program4 = App (App (App (App (TApp notail4 (JClass "java.lang.Integer")) summa) (TApp const (JClass "java.lang.Integer"))) (Lit (E.Integer 5))) (Lit (E.Integer 6))
