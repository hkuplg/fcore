...
-- type AOptUnboxType = StateT Int (ReaderT (Int, Bool) (Reader InitVars))
...
-- type StackUnboxType = ReaderT (Int, Bool) (State Int)
...
-- type StackType = ReaderT InitVars (ReaderT (Int, Bool) (State Int))
